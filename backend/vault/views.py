...
class AuditEventViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        # "organization" is serialized as PK, so join is not strictly necessary.
...
class AccessGrantViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        user = self.request.user
        # Optimization: Use select_related only for fields serialized as strings/objects.
        # vault_item and granted_by are serialized as PrimaryKey IDs, so joins are removed.
        return (
