...
class AuditEventViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        # Bolt Optimization: "organization" is serialized as PK, so removed select_related to avoid unnecessary JOIN.
...
class AccessGrantViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # "vault_item" and "granted_by" are serialized as PKs, so redundant joins are removed.
        return (
